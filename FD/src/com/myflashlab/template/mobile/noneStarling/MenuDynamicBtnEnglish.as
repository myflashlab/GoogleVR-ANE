package com.myflashlab.template.mobile.noneStarling 
{
	 ...
	 */
	public class MenuDynamicBtnEnglish extends MySprite
	{
		...
		public function MenuDynamicBtnEnglish():void
		{
		...
		private function initText():void
		{
			...
			_txtIcon.htmlText = "<p align='left'><font face='" + _fontIcon + "' size='" + _fontSizeIcon + "'>" + _icon + " " + "</font></p>";
			_txtIcon.mouseEnabled = false;
			_txtIcon.textColor = _iconColorOut;
			_txtIcon.x = _marginLeft;
			_txtIcon.y += Math.round((_txtIcon.height - _txtIcon.textHeight) / 2);
			...
			_txtLabel.htmlText = "<p align='left'><font face='" + _fontLabel + "' size='" + _fontSizeLabel + "'>" + _label + "</font></p>";
			_txtLabel.mouseEnabled = false;
			_txtLabel.textColor = _textColorOut;
			_txtLabel.x = _marginLeft + _iconWidth + _marginBetween;
...
//----------------------------------------------------------------------- properties
		...
		{
			_label = a;
			if (_txtLabel) _txtLabel.htmlText = "<p align='left'><font face='" + _fontLabel + "' size='" + _fontSizeLabel + "'>" + _label + "</font></p>";
		}
		...
		{
			_icon = a;
			if (_txtIcon) _txtIcon.htmlText = "<p align='left'><font face='" + _fontIcon + "' size='" + _fontSizeIcon + "'>" + _icon + " " + "</font></p>";
		}
