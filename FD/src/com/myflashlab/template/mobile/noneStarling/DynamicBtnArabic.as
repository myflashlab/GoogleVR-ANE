package com.myflashlab.template.mobile.noneStarling 
{
	 ...
	 */
	public class DynamicBtnArabic extends MySprite
	{
		...
		public function DynamicBtnArabic():void
		{
		...
		private function initText():void
		{
			...
			_iconTxt.y = _height - _iconTxt.textHeight >> 1;
			...
			{
				_labelTxt.x = (_width - _iconTxt.width - _labelTxt.width - _margin) * 0.5;
				_iconTxt.x = _labelTxt.x + _labelTxt.width + _margin;
			}
